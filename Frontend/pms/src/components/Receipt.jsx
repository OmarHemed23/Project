...
export default function Receipt(){
    return(
        <>
            <div className="flex w-full items-center justify-center bg-white border">
                <div className="w-full rounded bg-gray-50 px-8 pt-8 shadow-lg">
                    <Logo className="h-20 mx-auto" />
                    <div class="flex flex-col justify-center items-center gap-2">
                        <h4 class="font-semibold">OMAR PROPERTIES</h4>
                        <p class="text-xs">58858FHH</p>
                    </div>
